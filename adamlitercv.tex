...
\usepackage{pgffor}
	...
	% PUBLICATIONS
	% ------------------------------------------------------------------------------------------------
	%\DTLloaddb{publications}{content/publications.csv}
	% ------------------------------------------------------------------------------------------------
	% PRESENTATIONS
	% ------------------------------------------------------------------------------------------------
	\DTLloaddb{presentations}{content/presentations.csv}
	% Get each type of presentation
	\newcommand*{\PresentationTypes}{}
	\DTLforeach*{presentations}{\Type=Type}{%
		\expandafter\DTLifinlist\expandafter{\Type}{\PresentationTypes}%
		{}% do nothing if already in list
		{% else add to list
			\ifdefempty{\PresentationTypes}%
			{\let\PresentationTypes\Type}% first element of list
			{% else append to list
				\eappto\PresentationTypes{,\Type}%
			}%
		}%
	}%
	% Also a macro for looping through four authors
	\newcommand*{\PresentationAuthorLoop}{%
        \DTLifnullorempty{\FourthAuthorFirst}{%
        	% If there is NOT a fourth author
        	% Then check if there is a third author
        	\DTLifnullorempty{\ThirdAuthorFirst}{%
        		% If there is NOT a third author
        		% Then check if there is a second author
        		\DTLifnullorempty{\SecondAuthorFirst}{%
        			% If there is NOT a second author
        			.%
        		}{%
        			% If there is a second author
        			\mbox{ }\& \SecondAuthorFirst\DTLifnullorempty{\SecondAuthorMiddle}{\mbox{ }}{\mbox{ }\SecondAuthorMiddle\mbox{ }}\SecondAuthorLast.%	
        		}%
        	}{%
        		% If there is a third author
        		, \SecondAuthorFirst\DTLifnullorempty{\SecondAuthorMiddle}{\mbox{ }}{\mbox{ }\SecondAuthorMiddle\mbox{ }}\SecondAuthorLast, \& \ThirdAuthorFirst \DTLifnullorempty{\ThirdAuthorMiddle}{\mbox{ }}{\mbox{ }\ThirdAuthorMiddle\mbox{ }}\ThirdAuthorLast.%
        	}%
        }{%
        	% If there is a fourth author
        	, \SecondAuthorFirst\DTLifnullorempty{\SecondAuthorMiddle}{\mbox{ }}{\mbox{ }\SecondAuthorMiddle\mbox{ }}\SecondAuthorLast, \ThirdAuthorFirst \DTLifnullorempty{\ThirdAuthorMiddle}{\mbox{ }}{\mbox{ }\ThirdAuthorMiddle\mbox{ }}\ThirdAuthorLast, \& \FourthAuthorFirst \DTLifnullorempty{\FourthAuthorMiddle}{\mbox{ }}{\mbox{ }\FourthAuthorMiddle\mbox{ }}\FourthAuthorLast.%
        }%
	}%
	% ------------------------------------------------------------------------------------------------
	% TEACHING
...
\foreach \x in \PresentationTypes{%
	\subsection*{\x}
	\DTLforeach*[\DTLiseq{\Type}{\x}]{presentations}{%
		\Type=Type,
		\FirstAuthorFirst=FirstAuthorFirst,
		\FirstAuthorMiddle=FirstAuthorMiddle,
		\FirstAuthorLast=FirstAuthorLast,
		\SecondAuthorFirst=SecondAuthorFirst,
		\SecondAuthorMiddle=SecondAuthorMiddle,
		\SecondAuthorLast=SecondAuthorLast,
		\ThirdAuthorFirst=ThirdAuthorFirst,
		\ThirdAuthorMiddle=ThirdAuthorMiddle,
		\ThirdAuthorLast=ThirdAuthorLast,
		\FourthAuthorFirst=FourthAuthorFirst,
		\FourthAuthorMiddle=FourthAuthorMiddle,
		\FourthAuthorLast=FourthAuthorLast,
		\Year=Year,
		\Month=Month,
		\Title=Title,
		...
		\begin{minipage}{\textwidth}
			\frenchspacing
			\hangindent=1em
			\FirstAuthorLast, \FirstAuthorFirst\DTLifnullorempty{\FirstAuthorMiddle}{}{\mbox{ }\FirstAuthorMiddle}\PresentationAuthorLoop\mbox{ }(\Month, \Year).\mbox{ }\Title.\mbox{ }\PresentedAt, \Address.
			\DTLiflastrow{}{\vspace{1ex}}
		\end{minipage}
		%
	}%
